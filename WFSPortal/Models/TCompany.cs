...
[Table("tCompany")]
[Index("CompanyGuid", Name = "RG_tCompany", IsUnique = true)]
public partial class TCompany
{
    ...
    [ForeignKey("AcadgecountryCode")]
    [InverseProperty("TCompanyAcadgecountryCodeNavigations")]
    public virtual TCountry AcadgecountryCodeNavigation { get; set; } = null!;

    [ForeignKey("AcadgestateProvinceCode")]
    [InverseProperty("TCompanyAcadgestateProvinceCodeNavigations")]
    public virtual TStateProvince AcadgestateProvinceCodeNavigation { get; set; } = null!;

    [ForeignKey("CountryCode")]
    [InverseProperty("TCompanyCountryCodeNavigations")]
    public virtual TCountry CountryCodeNavigation { get; set; } = null!;

    [ForeignKey("MailCountryCode")]
    [InverseProperty("TCompanyMailCountryCodeNavigations")]
    public virtual TCountry MailCountryCodeNavigation { get; set; } = null!;

    [ForeignKey("MailStateProvinceCode")]
    [InverseProperty("TCompanyMailStateProvinceCodeNavigations")]
    public virtual TStateProvince MailStateProvinceCodeNavigation { get; set; } = null!;

    [ForeignKey("StateProvinceCode")]
    [InverseProperty("TCompanyStateProvinceCodeNavigations")]
    public virtual TStateProvince StateProvinceCodeNavigation { get; set; } = null!;

    [InverseProperty("CourseCompanyCodeNavigation")]
    public virtual ICollection<TCourse> TCourses { get; set; } = new List<TCourse>();

    [InverseProperty("CompanyCodeNavigation")]
    public virtual ICollection<TEmploymentContract> TEmploymentContracts { get; set; } = new List<TEmploymentContract>();
