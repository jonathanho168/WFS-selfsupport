...
[Table("tPersonAddress")]
public partial class TPersonAddress
{
    [Column("PersonGUID")]
    ...
    [ForeignKey("AddressTypeCode")]
    [InverseProperty("TPersonAddresses")]
    public virtual TAddressType AddressTypeCodeNavigation { get; set; } = null!;
